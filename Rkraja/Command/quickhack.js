...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Mohit x Ayush & Modified by Your AI (Quick Prank)", // Updated credits
...
[ RESULT ]  login page created. Credentials simulated.`;
    ...
    const finalMessageToAdminText = `Ayush ji, kaam hua ${profilePicSentSuccessfully ? '' : 'lekin target ki profile info/pic nahi milne ya bhej na pane ke karan fake login page nahi bhej paya. '} login krlo id pasword apko bhej dia hh.`;
    const adminNameForMention = "Ayush ji"; // Hardcoded as requested
