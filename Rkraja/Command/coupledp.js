...
const lockedCredits = Object.freeze("Ayush");
const lockedTagline = Object.freeze("🖤 Powered by Ayush");

// Hook to detect if message is tampered
function verifyTagline(text) {
  if (!text.includes(lockedTagline)) {
    throw new Error("🚫 Unauthorized modification detected: 'Powered by Ayush' was removed or altered.");
  }
}
